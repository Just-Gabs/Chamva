...
<html>
	<head>
		<title>Chamva - Tourisme adapté</title>
		<!--meta-->
		<meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.2" />
		<meta name="format-detection" content="telephone=no" />
		<meta name="keywords" content="Séjours adaptés, Tourisme adapté" />
		<meta name="description" content="Chamva organisation de vacances adaptées" />
		<!--slider revolution-->
		...
		<link rel="stylesheet" href="https://use.typekit.net/ulu5ujt.css">
		<!--fonts-->
		...
		<link rel="shortcut icon" href="images/icone44x43.png">
	</head>
	<!--<body class="image-1">
	...
	<body class="<?php echo (isset($_COOKIE['re_layout']) && $_COOKIE['re_layout']=="boxed" ? (isset($_COOKIE['re_layout_style']) && $_COOKIE['re_layout_style']!="" ? $_COOKIE['re_layout_style'] . ' ' . $_COOKIE['re_image_overlay'] : 'image-1 overlay') : ''); ?>">
		<div class="site-container<?php echo (isset($_COOKIE['re_layout']) && $_COOKIE['re_layout']=="boxed" ? ' boxed' : ''); ?>">
		<!--<div class="site-container boxed">-->
			<div class="header-top-bar-container clearfix">
				<div class="header-top-bar">
					<ul class="contact-details clearfix">
						<li class="template-phone">
							<a href="tel:0744994361">07.44.99.43.61</a>
						</li>
						<li class="template-mail">
							<a href="mailto:chamva.voyage@gmail.com">chamva.voyage@gmail.com</a>
						</li>
					</ul>
					<!-- <div class="search-container">
						<a class="template-search" href="#" title="Recherche"></a>
						<form class="search">
							<input type="text" name="s" placeholder="Rechercher..." value="Rechercher..." class="search-input hint">
					...
					<ul class="social-icons">
						<li>
							<a target="_blank" href="https://www.facebook.com/share/5u7kSvjqiYHVu4sJ/" title="facebook" class="social-facebook"></a>
						</li>
						<li>
							<a target="_blank" title="instagram" href="https://www.instagram.com/chamva.loisirs?igsh=MWxkZTltYWd1NzZsNQ==" class="social-instagram"></a>
						</li>
						<!--<li>
				...
				<div class="vertical-align-table column-1-1">
					<div class="header clearfix">
						<div class="logo vertical-align-cell">
							<h1><a href="?page=accueil" title="Chamva"><img src="images/logo157x49.png" class="img-fluid" alt="Logo"></a></h1>
						</div>
